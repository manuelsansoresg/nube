<div>
    <a class="link-profile"  data-toggle="modal" data-target="#listFollowers">
        <span> {{ $myFollowers }} <span class="text-muted font-weight-normal"> Seguidores </span> </span>
    </a>
    <!-- seguidores -->
    <div class="modal fade" id="listFollowers" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content h-600">
                ...
                <div class="modal-body modalListUser scroll-modal" id="contentlistFollowers">
                    <div v-if="isShow">
                        ...
                        <div class="container">
                            <div class="row mt-5 listado py-3" v-for="(user, key) in users">
                                <div class="col-3 col-md-3 offset-0 ml-md-n1 offset-md-1">
                                ...
                                <div class="col-6 offset-0 offset-md-0 col-md-5 align-self-center">
                                   <div class="row">
                                       <div class="col-7">
                                        ...
                                        <div v-if="user_id != null" class="d-inline col-5 d-inline text-left">
